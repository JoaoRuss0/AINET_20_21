...
clear_buttons.forEach(function (button) {
  button.addEventListener("click", function () {
    document.querySelectorAll(".filter input[type='text']").forEach(function (element) {
      element.setAttribute('value', "");
    });
    document.querySelectorAll(".filter select option").forEach(function (element) {
...
var user_email_element = document.getElementById("user_email"); // Payment reference field starts as disabled and without a pattern
